...
//           document.title = "CrediPlus - Préstamos";
...
//             (0, n.jsxs)("div", {
//               className: "jsx-aa6e8a7f7d099bdf min-h-screen bg-gradient-to-b from-purple-50 to-gray-100 flex flex-col items-center justify-start relative",
//               children: [
//                 // Header/Logo section
//                 (0, n.jsx)("div", {
//                   className: "jsx-aa6e8a7f7d099bdf w-full bg-white shadow-sm border-b border-gray-100 flex justify-center py-3 px-6",
//                   children: (0, n.jsx)("div", {
//                     className: "jsx-aa6e8a7f7d099bdf w-full max-w-md flex justify-center items-center",
//                     children: (0, n.jsx)(d.default, { // Next.js Image component
//                       src: "/images/crediplus.jpeg",
//                       alt: "CrediPlus Logo",
//                       width: 180,
//                       height: 50,
...
//                   })
//                 }),
//                 // Main content area for loan simulation
//                 (0, n.jsxs)("div", {
//                   className: "jsx-aa6e8a7f7d099bdf w-full max-w-md space-y-8 pb-16 p-6",
//                   children: [
//                     // Title section with animation
//                     (0, n.jsx)("div", {
//                       className: "jsx-aa6e8a7f7d099bdf " + "text-center space-y-2 transition-all duration-1000 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8"),
//                       children: (0, n.jsxs)("h1", {
//                         className: "jsx-aa6e8a7f7d099bdf text-4xl font-light text-gray-900 leading-tight",
//                         children: ["Simulá tu ", (0, n.jsx)("span", {
//                           className: "jsx-aa6e8a7f7d099bdf text-purple-600 font-semibold",
//                           children: "préstamo"
//                         }), " y recibilo al instante"]
//                       })
//                     }),
//                     // Loan amount selection
//                     (0, n.jsxs)("div", {
//                       className: "jsx-aa6e8a7f7d099bdf " + "space-y-6 transition-all duration-1000 delay-200 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"),
//                       children: [
//                         (0, n.jsx)("p", {
//                           className: "jsx-aa6e8a7f7d099bdf text-center text-gray-600 text-lg font-normal",
//                           children: "¿Cuánto querés pedir?"
//                         }),
//                         (0, n.jsx)("div", {
//                           className: "jsx-aa6e8a7f7d099bdf text-center",
//                           children: (0, n.jsx)("span", {
//                             className: "jsx-aa6e8a7f7d099bdf text-5xl font-bold text-purple-600",
//                             children: h(e[0]) // Display formatted loan amount
//                           })
//                         }),
//                         (0, n.jsx)("div", {
//                           className: "jsx-aa6e8a7f7d099bdf px-4 relative",
//                           children: (0, n.jsxs)("div", {
//                             className: "jsx-aa6e8a7f7d099bdf relative",
//                             children: [
//                               (0, n.jsx)("input", { // Range slider for loan amount
//                                 type: "range",
//                                 min: 5e4, // 50,000
//                                 max: 1e6, // 1,000,000
//                                 step: 25e3, // 25,000
//                                 value: e[0],
//                                 onChange: e => a([Number.parseInt(e.target.value)]),
//                                 style: {
//                                   background: "linear-gradient(to right, #5f5cf6 0%, #8e55f7 ".concat((e[0] - 5e4) / 95e4 * 100, "%, #e5e7eb ").concat((e[0] - 5e4) / 95e4 * 100, "%, #e5e7eb 100%)")
//                                 },
//                                 className: "jsx-aa6e8a7f7d099bdf w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider-custom z-10 relative"
//                               }),
//                               (0, n.jsx)("div", { // Custom thumb indicator for the slider
//                                 style: {
//                                   left: "".concat((e[0] - 5e4) / 95e4 * 100, "%"),
//                                   border: "2px solid #8e55f7"
//                                 },
//                                 className: "jsx-aa6e8a7f7d099bdf absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2 w-6 h-6 bg-white rounded-full shadow-md flex items-center justify-center pointer-events-none z-20"
//                               })
//                             ]
//                           })
//                         })
...
//                     // Loan term selection
//                     (0, n.jsxs)("div", {
//                       className: "jsx-aa6e8a7f7d099bdf " + "space-y-6 transition-all duration-1000 delay-400 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"),
//                       children: [
//                         (0, n.jsx)("p", {
//                           className: "jsx-aa6e8a7f7d099bdf text-center text-gray-600 text-lg font-normal",
//                           children: "¿En cuánto tiempo?"
//                         }),
//                         (0, n.jsx)("div", {
//                           className: "jsx-aa6e8a7f7d099bdf flex justify-center gap-3 flex-wrap",
//                           children: k.map((e, a) => ( // Maps over loan term options to create buttons
//                             (0, n.jsx)("button", {
//                               onClick: () => s(e.value), // Updates selected term on click
//                               className: "jsx-aa6e8a7f7d099bdf " + "px-4 py-2 rounded-full text-sm transition-all duration-150 font-medium ".concat(t === e.value ? "bg-purple-600 text-white shadow-lg scale-105 font-semibold" : "bg-gray-200 text-gray-700 hover:bg-gray-300", " ").concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"),
//                               children: e.label
//                             }, e.value)
//                           ))
//                         })
//                       ]
//                     }),
//                     // Estimated installment value and interest display
//                     (0, n.jsxs)("div", {
//                       className: "jsx-aa6e8a7f7d099bdf " + "text-center space-y-3 transition-all duration-1000 delay-700 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"),
//                       children: [
//                         (0, n.jsx)("p", {
//                           className: "jsx-aa6e8a7f7d099bdf text-gray-600 text-lg font-normal",
//                           children: "Valor de cuota"
//                         }),
//                         (0, n.jsx)("p", {
//                           className: "jsx-aa6e8a7f7d099bdf text-4xl font-bold text-gray-800",
//                           children: h((() => { // Calculates and displays installment value
//                             let a = e[0] * (1 + l); // Loan amount * (1 + interest rate)
//                             return "15 días" === t ? Math.round(a) : "30 días" === t ? Math.round(a) : Math.round(a / Number.parseInt(t.split(" ")[0]))
//                           })())
//                         }),
//                     //     (0, n.jsxs)("p", {
//                     //       className: "jsx-aa6e8a7f7d099bdf text-sm text-gray-500 font-normal",
//                     //       children: ["Interes: ", (100 * l).toFixed(0), "%"] // Displays formatted interest percentage
//                     //     })
//                     //   ]
//                     // }),

//                     (0,n.jsxs)("p",{className:"jsx-aa6e8a7f7d099bdf text-sm text-gray-500 font-normal",children:["Interes: ",(100*l).toFixed(0),"%"]})]}),  
//                     (0,n.jsxs)("div",{className:"jsx-aa6e8a7f7d099bdf "+"space-y-4 transition-all duration-1000 delay-900 ".concat(u?"opacity-100 translate-y-0":"opacity-0 translate-y-8"),children:[(0,n.jsxs)("a",{href:(()=>{let a=y(e[0]),t=j();return"https://wa.me/3765084215?text=Me%20interesa%20solicitar%20un%20pr%C3%A9stamo%20de%20%24%C2%A0".concat(a,"%20para%20pagar%20en%20").concat(t,".")})(),target:"_blank",rel:"noopener noreferrer",style:{boxShadow:"0 8px 25px rgba(97, 74, 217, 0.4), 0 4px 15px rgba(224, 59, 168, 0.3)"},onMouseEnter:()=>f(!0),onMouseLeave:()=>{f(!1),b(!1)},onMouseDown:()=>b(!0),onMouseUp:()=>b(!1),className:"jsx-aa6e8a7f7d099bdf "+"gradient-button w-full h-16 text-white text-xl rounded-full relative overflow-hidden flex items-center justify-center transition-all duration-200 font-bold uppercase tracking-wide ".concat(m?"scale-95":x?"scale-102":""),children:[(0,n.jsx)("span",{className:"jsx-aa6e8a7f7d099bdf mr-6 relative z-10",children:"SOLICITAR PRESTAMO"}),(0,n.jsx)("div",{className:"jsx-aa6e8a7f7d099bdf "+"absolute right-6 transition-transform duration-200 z-10 ".concat(x?"translate-x-1":""),children:(0,n.jsx)(o.A,{className:"h-6 w-6"})})]}),(0,n.jsx)("p",{className:"jsx-aa6e8a7f7d099bdf text-center text-sm text-gray-400 font-normal",children:"Sujeto a evaluación crediticia."})]}),
                    
//                     // "Request Loan" button (WhatsApp link)
//                     // (0, n.jsxs)("div", { // Conditional rendering based on `0`? (Likely always true after minification)
//                     //   className: "jsx-aa6e8a7f7d099bdf " + "space-y-4 transition-all duration-1000 delay-900 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"),
//                     //   children: [
//                     //     (0, n.jsxs)("a", {
//                     //       href: (() => { // Generates WhatsApp link with loan details
//                     //         let a = y(e[0]),
//                     //           t = j();
//                     //         return "https://wa.me/3765084215?text=Me%20interesa%20solicitar%20un%20pr%C3%A9stamo%20de%20%24%C2%A0".concat(a, "%20para%20pagar%20en%20").concat(t, ".")
//                     //       })(),
//                     //       target: "_blank",
//                     //       rel: "noopener noreferrer",
//                     //       style: {
//                     //         boxShadow: "0 8px 25px rgba(97, 74, 217, 0.4), 0 4px 15px rgba(224, 59, 168, 0.3)"
//                     //       },
//                     //       onMouseEnter: () => f(!0), // Mouse hover effects
//                     //       onMouseLeave: () => {
//                     //         f(!1), b(!1)
//                     //       },
//                     //       onMouseDown: () => b(!0), // Mouse click effects
//                     //       onMouseUp: () => b(!1),
//                     //       className: "jsx-aa6e8a7f7d099bdf " + "gradient-button w-full h-16 text-white text-xl rounded-full relative overflow-hidden flex items-center justify-center transition-all duration-200 font-bold uppercase tracking-wide ".concat(m ? "scale-95" : x ? "scale-102" : ""),
//                     //       children: [
//                     //         (0, n.jsx)("span", {
//                     //           className: "jsx-aa6e8a7f7d099bdf mr-6 relative z-10",
//                     //           children: "SOLICITAR PRESTAMO"
//                     //         }),
//                     //         (0, n.jsx)("div", {
//                     //           className: "jsx-aa6e8a7f7d099bdf " + "absolute right-6 transition-transform duration-200 z-10 ".concat(x ? "translate-x-1" : ""),
//                     //           children: (0, n.jsx)(o.A, { // ChevronRight icon
//                     //             className: "h-6 w-6"
//                     //           })
//                     //         })
//                     //       ]
...
//                     //     (0, n.jsx)("p", {
//                     //       className: "jsx-aa6e8a7f7d099bdf text-center text-sm text-gray-400 font-normal",
//                     //       children: "Sujeto a evaluación crediticia."
//                     //     })
//                     //   ]
//                     // }),
//                     // Reasons to choose CrediPlus section
//                     (0, n.jsxs)("div", {
//                       className: "jsx-aa6e8a7f7d099bdf " + "space-y-6 mt-12 transition-all duration-1000 delay-1000 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"),
//                       children: [
//                         (0, n.jsxs)("h2", {
//                           className: "jsx-aa6e8a7f7d099bdf text-2xl text-center",
//                           children: ["3 razones", (0, n.jsx)("br", {
//                             className: "jsx-aa6e8a7f7d099bdf"
//                           }), "para pedirlo en CrediPlus"]
//                         }),
//                         (0, n.jsxs)("div", {
//                           className: "jsx-aa6e8a7f7d099bdf space-y-4",
//                           children: [
//                             // Reason 01: Préstamos inmediatos
//                             (0, n.jsx)("div", {
//                               className: "jsx-aa6e8a7f7d099bdf " + "bg-white rounded-3xl p-6 shadow-sm transition-all duration-700 delay-1200 ".concat(u ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"),
//                               children: (0, n.jsxs)("div", {
//                                 className: "jsx-aa6e8a7f7d099bdf flex items-start space-x-4",
//                                 children: [
//                                   (0, n.jsx)("div", {
//                                     className: "jsx-aa6e8a7f7d099bdf text-4xl font-bold text-purple-200",
//                                     children: "01"
//                                   }),
//                                   (0, n.jsxs)("div", {
//                                     className: "jsx-aa6e8a7f7d099bdf",
//                                     children: [
//                                       (0, n.jsx)("h3", {
//                                         className: "jsx-aa6e8a7f7d099bdf text-xl font-bold text-gray-900 mb-2",
//                                         children: "Préstamos inmediatos"
//                                       }),
//                                       (0, n.jsx)("p", {
//                                         className: "jsx-aa6e8a7f7d099bdf text-gray-500 text-sm font-normal",
//                                         children: "Sin documentación interminable ni trámites eternos. Lo pedís, y lo recibís."
//                                       })
//                                     ]
//                                   })
//                                 ]
//                               })
//                             }),
//                             // Reason 02: Adelantos rapidos
//                             (0, n.jsx)("div", {
//                               className: "jsx-aa6e8a7f7d099bdf " + "bg-white rounded-3xl p-6 shadow-sm transition-all duration-700 delay-1400 ".concat(u ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"),
//                               children: (0, n.jsxs)("div", {
//                                 className: "jsx-aa6e8a7f7d099bdf flex items-start space-x-4",
//                                 children: [
//                                   (0, n.jsx)("div", {
...
//                                       (0, n.jsx)("h3", {
//                                         className: "jsx-aa6e8a7f7d099bdf text-xl font-bold text-gray-900 mb-2",
//                                         children: "Adelantos rapidos"
//                                       }),
//                                       (0, n.jsx)("p", {
//                                         className: "jsx-aa6e8a7f7d099bdf text-gray-500 text-sm font-normal",
//                                         children: "¿Necesitás salir del apuro? Pedí un adelanto y pagalo a los 15, 30, 60 o mas días."
//                                       })
//                                     ]
//                                   })
//                                 ]
//                               })
//                             }),
//                             // Reason 03: Control total desde WhatsApp
//                             (0, n.jsx)("div", {
//                               className: "jsx-aa6e8a7f7d099bdf " + "bg-white rounded-3xl p-6 shadow-sm transition-all duration-700 delay-1600 ".concat(u ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"),
//                               children: (0, n.jsxs)("div", {
//                                 className: "jsx-aa6e8a7f7d099bdf flex items-start space-x-4",
//                                 children: [
//                                   (0, n.jsx)("div", {
...
//                                       (0, n.jsx)("h3", {
//                                         className: "jsx-aa6e8a7f7d099bdf text-xl font-bold text-gray-900 mb-2",
//                                         children: "Control total desde WhatsApp"
//                                       }),
//                                       (0, n.jsx)("p", {
//                                         className: "jsx-aa6e8a7f7d099bdf text-gray-500 text-sm font-normal",
//                                         children: "Gestioná tus préstamos, adelantos y pagos directo por WhatsApp. Sin llamadas, sin papeles, sin complicaciones."
//                                       })
//                                     ]
//                                   })
//                                 ]
...
//                     (0, n.jsx)("div", {
//                       className: "jsx-aa6e8a7f7d099bdf text-center mt-8 pb-8",
//                       children: (0, n.jsx)("a", {
//                         href: "https://wa.me/3765084215?text=Buenas,%20quisiera%20consultar%20los%20t%C3%A9rminos%20y%20condiciones.",
//                         target: "_blank",
//                         rel: "noopener noreferrer",
//                         className: "jsx-aa6e8a7f7d099bdf text-gray-400 text-sm underline hover:text-gray-600 font-normal",
//                         children: "Consulta terminos y condiciones aca."
//                       })
//                     })
//                   ]
//                 })
...
//             (0, n.jsx)("a", {
//               href: "https://wa.me/5493765084215",
//               target: "_blank",
//               rel: "noopener noreferrer",
//               style: {
...
//               className: "jsx-aa6e8a7f7d099bdf " + "fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 z-50 flex items-center justify-center hover:scale-110 transition-all duration-300 ".concat(u ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"),
...
//                 viewBox: "0 0 24 24",
//                 fill: "currentColor",
//                 className: "jsx-aa6e8a7f7d099bdf text-white",
...
//               })
//             }),
//             // styled-jsx CSS definitions
//             (0, n.jsx)(i(), {
//               id: "aa6e8a7f7d099bdf",
//               children: '/* Minified CSS is quite long, but it defines styles for gradient buttons, slider, and responsive adjustments */'
//             })
//           ]
//         });
//       }
